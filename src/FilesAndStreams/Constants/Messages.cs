...
/// <summary>
/// Constants used as messages.
/// </summary>
public static class Messages
{
    /// <summary>
    /// To display title of app.
    /// </summary>
    ...
    /// </summary>
    public const string Task1MenuPrompt = "1. Create sample files\n2. Read sample files\n3. Process sample files\n4. Exit";
    ...
    /// <summary>
    /// To display title of create.
    /// </summary>
    public const string Create = "Create";

    /// <summary>
    /// To display title of create async.
    /// </summary>
    ...
    /// <summary>
    /// To display title of read.
    /// </summary>
    public const string Read = "Read";

    /// <summary>
    /// To display title of read async.
    /// </summary>
    ...
    /// <summary>
    /// To display title of process
    /// </summary>
    public const string Process = "Process";

    /// <summary>
    /// To display title of process async.
    /// </summary>
