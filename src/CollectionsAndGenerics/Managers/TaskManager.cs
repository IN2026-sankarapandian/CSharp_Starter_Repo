...
public class TaskManager
{
    ...
    private void ExecuteTask2()
    {
        ...
        do
        {
            this._userInterface.ShowMessage(MessageType.Prompt, Messages.EnterStringToReverse);
            userInput = this._userInterface.GetInput();
        ...
        this._userInterface.ShowMessage(MessageType.Result, string.Format(Messages.ReversedOutputForGivenInput, userInput, reversedString));
