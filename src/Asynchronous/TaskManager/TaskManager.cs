...
namespace Asynchronous.TaskManagers;

/// <summary>
/// Handles the tasks of assignment <see cref="Asynchronous"/>.
/// </summary>
public class TaskManager
{
    ...
    public void HandleMenu()
    {
        while (true)
        {
            this._userInterface.ShowMessage(MessageType.Title, Messages.AppTitle);
