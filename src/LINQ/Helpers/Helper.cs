...
public class Helper
{
    ...
    public static void AddDummyProducts(List<Product> products)
    {
        ...
        products.Add(new Product { ID = "006", Name = "Phone Case", Price = 1200, Category = "Electronics" });
        products.Add(new Product { ID = "007", Name = "Water Bottle", Price = 800, Category = "Others" });
        products.Add(new Product { ID = "008", Name = "Headphones", Price = 4000, Category = "Electronics" });
        products.Add(new Product { ID = "009", Name = "Sticky Notes", Price = 300, Category = "Stationery" });
        products.Add(new Product { ID = "010", Name = "Smartwatch", Price = 10000, Category = "Electronics" });
        products.Add(new Product { ID = "011", Name = "Mouse Pad", Price = 600, Category = "Electronics" });
        products.Add(new Product { ID = "012", Name = "Charger", Price = 2500, Category = "Electronics" });
        products.Add(new Product { ID = "013", Name = "Desk Organizer", Price = 1800, Category = "Stationery" });
        products.Add(new Product { ID = "014", Name = "Laptop Stand", Price = 3000, Category = "Electronics" });
        products.Add(new Product { ID = "015", Name = "Cable Organizer", Price = 700, Category = "Electronics" });
